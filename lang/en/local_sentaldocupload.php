...
$string['activeedsdocumentblocksupload'] = 'A course completion document cannot be uploaded for {$a->learner} in "{$a->course}" because an EDS/NCA course completion document already exists or is waiting for signature for this learner and course. Only one course completion document is allowed at a time. Current EDS/NCA status: {$a->status}. Expiry: {$a->expiry}.';
