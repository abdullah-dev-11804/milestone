...
$string['activeedsdocumentblocksupload'] = '{$a->learner} already has an EDS/NCA course completion document in "{$a->course}" or one is waiting for signature. Uploading this Type 1 document will replace that generated document for display, Analytics, and related areas. Current EDS/NCA status: {$a->status}. Expiry: {$a->expiry}.';
$string['edsstatusactive'] = 'Active';
$string['edsstatuspending'] = 'Waiting for signature';
$string['edsconflictchecking'] = 'Checking existing EDS certificates...';
$string['edsconflictcheckfailed'] = 'Could not check existing EDS certificates. The upload will still be checked before saving.';
$string['edsreplaceconfirmtitle'] = 'Replace existing EDS/NCA document?';
$string['edsreplaceconfirmbody'] = 'This Type 1 upload will replace the generated EDS/NCA course completion document for the affected learner(s). The old job will be hidden from active document views and Analytics, but kept internally for audit.';
$string['edsreplaceconfirmbutton'] = 'Replace and upload';
$string['edsreplaceconfirmfallback'] = 'Replace existing EDS/NCA documents for the affected users?';
...
$string['coursecompletiondisabledwarning'] = 'Course completion is not enabled for this course, so completion progress and duration may be unavailable.';
...
$string['publicprofilevisibilitybulkupdated'] = 'Public Profile visibility updated for {$a} selected document(s).';
$string['publicprofileshowselected'] = 'Show selected in Public Profile';
$string['publicprofilehideselected'] = 'Hide selected from Public Profile';
